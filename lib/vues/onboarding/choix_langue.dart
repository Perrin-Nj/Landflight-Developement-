...
class _ChoixLangueState extends State<ChoixLangue> {
  ...
  Future shouldGoLogin = checkIfOnboardingAlreadyMade();

  @override
  Widget build(BuildContext context) {
    return FutureBuilder(
        future: shouldGoLogin,
    ...
    return Row(
      ...
      children: [
        Container(
          ...
          child: const Image(
              width: 120, image: AssetImage("assets/images/logo.png")),
        )
      ],
    );
  }
  ...
  getLanguagesImages() {
    return Container(
        ...
        child: Row(
          ...
          children: [
            getLanguageCard("assets/images/french flag.png", "Français", () {
              changeLanguage("français");
            }),
            getLanguageCard("assets/images/english flag.png", "English", () {
  ...
  getNextIcon() {
    return const Image(image: AssetImage("assets/images/nextIcon.png"));
  }
